...
{
    public static class CategoryGraphicOverrideTranslator
    {
        ...
        public static void ApplyOverridesToView(this CategoryGraphicOverridesModel serialOverride, View view, IIdentityService identityService)
        {
            GraphicOverrideUtility.ModifyOverrideGraphicSettings(serialOverride, view, identityService);
        }

        public static void ApplyOverridesToView(this CategoryGraphicOverridesModel serialOverride, View view)
        {
            GraphicOverrideUtility.ModifyOverrideGraphicSettings(serialOverride, view);
        }
}
}